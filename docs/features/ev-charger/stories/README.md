...
- [ ] [Story 01 - Break the DTO contract and scaffold the FE client](./story-01-dto-foundation.md)
- [ ] [Story 02 - Read appliance config and expose metadata (backend)](./story-02-config-and-metadata.md)

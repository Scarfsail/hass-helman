...
/** The Diagnostics panels, which are plain panels rather than scopes. */
export const DIAGNOSTICS_ICON = mdiStethoscope;
...
export const SECTION_ICONS: Record<string, string> = {
  ...
  // something: the info icon it carried read as a hint rather than a filter.
  "section:training.solar_bias.slot_invalidation": mdiFilterRemoveOutline,
...
export const EDITOR_SCOPES = {
  ...
  [SECTION_SCOPE_IDS.training.solar_bias_slot_invalidation]: {
    id: SECTION_SCOPE_IDS.training.solar_bias_slot_invalidation,
    kind: "section",
    parentId: SECTION_SCOPE_IDS.training.solar_bias,
    tabId: "training",
    labelKey: "editor.sections.bias_correction_slot_invalidation",
    adapter: createPathScopeAdapter(["training", "solar_bias", "slot_invalidation"], {
      emptyValue: EMPTY_OBJECT,
      rootKind: "object",
    }),
  },
  ...
  [SECTION_SCOPE_IDS.automation.appliance_optimizer_pipeline]: {
    id: SECTION_SCOPE_IDS.automation.appliance_optimizer_pipeline,
    kind: "section",
    parentId: TAB_SCOPE_IDS.automation,
    tabId: "automation",
    labelKey: "editor.sections.appliance_optimizer_pipeline",
    adapter: createPathScopeAdapter(["automation", "appliance_optimizers"], {
      emptyValue: EMPTY_ARRAY,
      rootKind: "array",
    }),
  },
  [SECTION_SCOPE_IDS.automation.system_optimizer_pipeline]: {
    id: SECTION_SCOPE_IDS.automation.system_optimizer_pipeline,
    kind: "section",
    parentId: TAB_SCOPE_IDS.automation,
    tabId: "automation",
    labelKey: "editor.sections.system_optimizer_pipeline",
    adapter: createPathScopeAdapter(["automation", "system_optimizers"], {
      emptyValue: EMPTY_ARRAY,
      rootKind: "array",
    }),
  },

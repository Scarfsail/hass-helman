...
When Helman schedules an appliance (`appliance_runtime`), it can ask what running it *does* to the
...
even *without* the appliance, the inspector says so rather than blaming the appliance for it.

The mechanism, the trace codes and the config migration are documented in
[docs/features/automation/optimizers/helman-appliance-runtime-self-sustainability-implementation-plan.md](docs/features/automation/optimizers/helman-appliance-runtime-self-sustainability-implementation-plan.md).

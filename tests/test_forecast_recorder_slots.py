...
class ForecastRecorderSlotTests(unittest.TestCase):
    ...
    def test_build_active_state_intervals_matches_heat_and_cool(self) -> None:
        states = [
            SimpleNamespace(
                state="heat",
                last_updated=datetime(2026, 3, 20, 9, 50, tzinfo=UTC),
        ...
        intervals = recorder_hourly_series._build_active_state_intervals(
            states=states,
            window_start=datetime(2026, 3, 20, 10, 0, tzinfo=UTC),
            window_end=datetime(2026, 3, 20, 11, 0, tzinfo=UTC),
    ...
    def test_estimate_average_hourly_energy_for_active_intervals(self) -> None:
        entity_states = [
            SimpleNamespace(
                state="heat",
                last_updated=datetime(2026, 3, 20, 10, 0, tzinfo=UTC),

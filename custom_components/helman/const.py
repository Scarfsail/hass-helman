...
SOLAR_FORECAST_HISTORY_STORAGE_KEY = f"{DOMAIN}.solar_forecast_history"
SOLAR_FORECAST_HISTORY_STORAGE_VERSION = 1
SOLAR_FORECAST_HISTORY_RETENTION_DAYS = 90
